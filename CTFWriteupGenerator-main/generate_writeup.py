...
def main():
    ...
    content += generate_badge("Author", "crxzii",
                              Color.BLUE) + " "
    ...
    filename = formatted_challenge_name + ".md"

    # Write to the file
    with open("writeups/" + filename, "w") as file:
        file.write(content)

    # Print a success message
    print("The write-up file " + filename + " was generated!")
